...
HD_PWD='D:/Programming/Git/cse125/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log regex.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source regex.tcl
