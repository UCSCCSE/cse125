...
HD_PWD='D:/Programming/Git/cse125/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_4.tcl -notrace
